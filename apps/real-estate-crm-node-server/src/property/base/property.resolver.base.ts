...
export class PropertyResolverBase {
  ...
  async createProperty(
    ...
    return await this.service.createProperty({
      ...
      data: {
        ...
        agentAssignment: args.data.agentAssignment
          ? {
              connect: args.data.agentAssignment,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => AgentAssignment, {
    nullable: true,
  ...
  async getAgentAssignment(
    ...
    const result = await this.service.getAgentAssignment(parent.id);
